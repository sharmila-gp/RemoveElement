		...
		if((a_input.value =="")&&(b_input.value ==""))
		{
			...
			edit.onclick=function(){
				...
				c_btn.addEventListener("click",function(){
					if(c_btn.innerHTML=="Update"){
						/*document.getElementById("name"+arr[1]).innerHTML = a_input.value;
						document.getElementById("col"+arr[1]).innerHTML = b_input.value;*/
						
						var elem1 = document.getElementById("st_name"+arr[1]);
						var elem2 = document.getElementById("col"+arr[1]);
						
						console.log(arr[1]);	
						
						console.log(a_input,b_input);
